...
DAYS_NO_CONNECTIVITY_MAX = 997  # do not allow to engage after 997 days without internet
DAYS_NO_CONNECTIVITY_PROMPT = 994  # send an offroad prompt after 994 days with no internet
